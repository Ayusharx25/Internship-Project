...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-0 mb-5 border-b border-b-gray-400'>
        <img onClick={()=>navigate('/')} className='w-32 cursor-pointer' src={assets.docbook} alt="" />
        ...
        <div className='flex items-center gap-4'>
            {
                ...
                <div className='flex items-center gap cursor-pointer group relative'>
                    ...
                    <img className='w-2.5 gap m-1' src={assets.dropdown_icon} alt=""/>
            ...
            <div className={`${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all duration-300`}>
                <div className='flex items-center justify-between px-5 py-4 border-b'>
                    <img className='w-24' src={assets.docbook} alt="" />
                    <img className='w-6 cursor-pointer' onClick={()=>setShowMenu(false)} src={assets.cross_icon} alt="" />
                </div>
                <ul className='flex flex-col items-center gap-2 mt-4 px-4 text-lg font-medium'>
